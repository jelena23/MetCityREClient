...
// Model for User entity
    models.User = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/MetCityRE/webresources/com.mycompany.metcityre.user/",
        idAttribute: 'idUser',
        defaults: {
            userAddress: "",
            firstName: "",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/MetCityRE/webresources/com.mycompany.metcityre.user/';
            }
    ...
    models.UserCollection = Backbone.Collection.extend({
        model: models.User,
        url: "http://localhost:8080/MetCityRE/webresources/com.mycompany.metcityre.user/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
